...
if TYPE_CHECKING:
    ...
    from .diff_view import ThreadDiffView


class NearTaskTableModel(QTableModelBase):
    disable_column = (0, 1, 2)

    def __init__(
            self,
            gui: "VisageGUI",
            parent: "ThreadDiffView" = None,
            table_view=None,
    ):
        ...
        self.columns_ratio = [1, 3, 3]
        self.ui = parent

    @property
    def model_data(self):
        return self.ui.task_table_data
