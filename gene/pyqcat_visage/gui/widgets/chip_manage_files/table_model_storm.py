...
if TYPE_CHECKING:
    ...
    from ..storm_manage import StormManagerWindow
    from .table_view_storm import QTableViewStormWidget


class QTableModelStormManage(QTableModelBase):
    disable_column = (0, 1, 2)

    def __init__(
        self,
        gui: "VisageGUI",
        parent: "StormManagerWindow" = None,
        table_view: "QTableViewStormWidget" = None,
    ):
    ...
    def setData(
        ...
        if value is None or not index.isValid():
            ...
            logger.info(
                f"Setting parameter data:{column_name}: old value={old_value}; new value={value};"
            )
            return True
