...
class CMakeBuild(build_ext):
    def build_extension(self, ext):
        ...
        cmake_args += [f"-DFREQ_ALLOCATOR_VERSION_INFO={self.distribution.get_version()}"]
...
setup(
    ...
    cmdclass=cmdclass,
    project_urls={
        "Source Code": "https://github.com/Agony5757/FreqAllocator",
    },
    classifiers=[_f for _f in CLASSIFIERS.split('\n') if _f],
    packages = find_packages(),
    package_data={
        'freq_allocator' : ['*.pyi'],
        'freq_allocator.stubs' : ['*.pyi'],
        'freq_allocator.model_cpp' : ['*.pyi'],
    },
