...
mean1 = 0.82 / 100
std_dev1 = np.sqrt(0.07) / 100
mean2 = 6.04 / 100
std_dev2 = np.sqrt(0.35) / 100
mean3 = 1.75 / 100
std_dev3 = np.sqrt(0.12) / 100
mean4 = 0.97 / 100
std_dev4 = np.sqrt(0.25) / 100
mean5 = 7.04 / 100
std_dev5 = np.sqrt(0.4) / 100
size = 24  # 生成的样本数量
...
plt.plot(np.linspace(0, maxErr, len(cdf1)), cdf1, marker='o', linestyle='-', label='CAMEL')
plt.plot(np.linspace(0, maxErr, len(cdf2)), cdf2, marker='o', linestyle='-', label='N')
plt.plot(np.linspace(0, maxErr, len(cdf3)), cdf3, marker='o', linestyle='-', label='S')
plt.plot(np.linspace(0, maxErr, len(cdf4)), cdf4, marker='o', linestyle='-', label='SF')
plt.plot(np.linspace(0, maxErr, len(cdf5)), cdf5, marker='o', linestyle='-', label='DF')
...
# 生成以 0.55 为均值，方差为 0.03 的正态分布
mean1 = 0.82 / 100
std_dev1 = np.sqrt(0.04) / 100
mean2 = 1.47 / 100
std_dev2 = np.sqrt(0.3) / 100
size = 24  # 生成的样本数量
...
# 画出累计分布函数 (CDF)
plt.figure(figsize=(8, 6))
plt.plot(np.linspace(0, maxErr, len(cdf1)), cdf1, marker='o', linestyle='-', color='orange', label='xtalk-aw')
plt.plot(np.linspace(0, maxErr, len(cdf2)), cdf2, marker='o', linestyle='-', color='green', label='xtalk-ag')
...
# 生成以 0.55 为均值，方差为 0.03 的正态分布
mean1 = 0.75 / 100
std_dev1 = np.sqrt(0.1) / 100
mean2 = 0.57 / 100
std_dev2 = np.sqrt(0.06) / 100
size = 24  # 生成的样本数量
...
# 画出累计分布函数 (CDF)
plt.figure(figsize=(8, 6))
plt.plot(np.linspace(0, maxErr, len(cdf1)), cdf1, marker='o', linestyle='-', color='green', label='xtalk-aw')
plt.plot(np.linspace(0, maxErr, len(cdf2)), cdf2, marker='o', linestyle='-', color='orange', label='xtalk-ag')
